...
##packages to transfer the data into R and to process the data
...
#COLUMNS REPRESENT CONDITIONS AND ROWS REPRESENT INDIVIDUALS
# READ THE DATA. WE PREPARED OUR DATA AS AN spss FILE NAMED f3. THE CONDITIONS NAMED X1, X2, ETC.
